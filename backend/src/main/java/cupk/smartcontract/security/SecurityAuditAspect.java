...
public class SecurityAuditAspect {
    ...
    public Object audit(ProceedingJoinPoint joinPoint, AuditOperation audit) throws Throwable {
        Long targetId = findTargetId(joinPoint, audit);
        try {
    ...
    private Long findTargetId(ProceedingJoinPoint joinPoint, AuditOperation audit) {
        Long spelTargetId = findTargetIdByExpression(joinPoint, audit.targetId());
        if (spelTargetId != null) {
            return spelTargetId;
        }
        String parameterName = audit.targetIdParameter();
    ...
    private Long findTargetIdByExpression(ProceedingJoinPoint joinPoint, String expression) {
        ...
        try {
            ...
            // Invalid audit metadata should not affect the business request.
        }
        return null;
    }
    ...
    private Long resolveTargetId(Object result) {
        ...
        return body instanceof ContractMain contract ? contract.getContractId() : null;
    }
