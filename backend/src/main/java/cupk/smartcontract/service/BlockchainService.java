...
public class BlockchainService {
    ...
    private void assertCanAccess(Long contractId) {
        ...
        boolean allowed = switch (scope) {
            case "SELF" -> Objects.equals(SecurityContext.userId(), contract.getOwnerId());
            case "DEPT" -> Objects.equals(SecurityContext.deptId(), contract.getDeptId());
            default -> true;
        };
        if (!allowed) {
